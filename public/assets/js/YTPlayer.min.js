    ...
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            ...
            return this.each(function() {
                ...
                $YTPlayer.hide(), YTPlayer.loop = 0, YTPlayer.state = 0, YTPlayer.filters = jQuery.extend(!0, {}, jQuery.mbYTPlayer.defaultFilters), YTPlayer.filtersEnabled = !0, YTPlayer.id = YTPlayer.id || "YTP_" + (new Date).getTime(), $YTPlayer.addclassName("mb_YTPlayer");
                ...
                if (YTPlayer.isPlayer && $YTPlayer.show(), YTPlayer.overlay = jQuery("<div/>").css({
                        ...
                        width: "100%",
                        height: "100%"
                    }).addclassName("YTPOverlay"), $YTPlayer.changeCoverImage(), YTPlayer.wrapper = jQuery("<div/>").attr("id", "wrapper_" + YTPlayer.id).css({
                        position: "absolute",
                        zIndex: 0,
                        minWidth: "100%",
                        minHeight: "100%",
                        ...
                        overflow: "hidden",
                        opacity: 0
                    }).addclassName("mbYTP_wrapper"), YTPlayer.isPlayer) {
                    let e = jQuery.mbBrowser.mobile ? "inlinePlayButtonMobile" : "inlinePlayButton";
                    YTPlayer.inlinePlayButton = jQuery("<div/>").addclassName("inlinePlayButton").html(jQuery.mbYTPlayer.controls.play), $YTPlayer.append(YTPlayer.inlinePlayButton), YTPlayer.inlinePlayButton.on("click", function(e) {
                ...
                let playerBox = jQuery("<div/>").attr("id", YTPlayer.playerID).addclassName("playerBox");
                if (playerBox.css({
                        position: "absolute",
                        zIndex: 0,
                        width: "100%",
                        ...
                        overflow: "hidden",
                        opacity: 1
                    }), YTPlayer.wrapper.append(playerBox), playerBox.after(YTPlayer.overlay), YTPlayer.isPlayer && (YTPlayer.inlineWrapper = jQuery("<div/>").addclassName("inline-YTPlayer"), YTPlayer.inlineWrapper.css({
                        position: "relative",
                        ...
                        YTPlayer.controlBar && YTPlayer.controlBar.length && YTPlayer.controlBar.addclassName("visible")
                    }).on("mouseleave", function() {
                        YTPlayer.controlBar && YTPlayer.controlBar.length && YTPlayer.controlBar.removeclassName("visible")
        ...
        getDataFromAPI: function(e) {
            ...
            }, 10), e.videoData = null), e.opt.ratio = "auto" == e.opt.ratio ? 16 / 9 : e.opt.ratio, e.isPlayer && !e.opt.autoPlay && (e.loading = jQuery("<div/>").addclassName("loading").html("Loading").hide(), jQuery(e).append(e.loading), e.loading.fadeIn())
        },
        ...
        fullscreen: function(real) {
            ...
            if (YTPlayer.isAlone) jQuery(document).off("mousemove.YTPlayer"), clearTimeout(YTPlayer.hideCursor), YTPlayer.overlay.css({
                ...
                jQuery(document).on("mousemove.YTPlayer", function(e) {
                    ...
                    opacity: 0
                }), videoWrapper.addclassName("YTPFullscreen"), launchFullscreen(videoWrapper.get(0)), setTimeout(function() {
        ...
        mute: function() {
            ...
            e.player.mute(), e.isMute = !0, e.player.setVolume(0), e.volumeBar && e.volumeBar.length && e.volumeBar.width() > 10 && e.volumeBar.updateSliderVal(0), jQuery("#controlBar_" + e.id).find(".mb_YTPMuteUnmute").html(jQuery.mbYTPlayer.controls.unmute), jQuery(e).addclassName("isMuted"), e.volumeBar && e.volumeBar.length && e.volumeBar.addclassName("muted");
        ...
        unmute: function() {
            ...
            if (!e.isReady) return this;
            if (!e.isMute) return this;
            e.player.unMute(), e.isMute = !1, jQuery(e).YTPSetVolume(e.opt.vol), e.volumeBar && e.volumeBar.length && e.volumeBar.updateSliderVal(e.opt.vol > 10 ? e.opt.vol : 10), jQuery("#controlBar_" + e.id).find(".mb_YTPMuteUnmute").html(jQuery.mbYTPlayer.controls.mute), jQuery(e).removeclassName("isMuted"), e.volumeBar && e.volumeBar.length && e.volumeBar.removeclassName("muted");
        ...
        buildControls: function(YTPlayer) {
            ...
            YTPlayer.controlBar = jQuery("<div/>").attr("id", "controlBar_" + YTPlayer.id).addclassName("mb_YTPBar").css({
                whiteSpace: "noWrap",
            ...
            let buttonBar = jQuery("<div/>").addclassName("buttonBar"),
                playpause = jQuery("<span>" + jQuery.mbYTPlayer.controls.play + "</span>").addclassName("mb_YTPPlayPause ytpicon").on("click", function(e) {
                    e.stopPropagation(), jQuery(YTPlayer).YTPTogglePlay()
                }),
                MuteUnmute = jQuery("<span>" + jQuery.mbYTPlayer.controls.mute + "</span>").addclassName("mb_YTPMuteUnmute ytpicon").on("click", function(e) {
                    e.stopPropagation(), jQuery(YTPlayer).YTPToggleVolume()
                }),
                volumeBar = jQuery("<div/>").addclassName("mb_YTPVolumeBar").css({
                    display: "inline-block"
                });
            YTPlayer.volumeBar = volumeBar;
            let idx = jQuery("<span/>").addclassName("mb_YTPTime"),
                vURL = YTPlayer.opt.videoURL ? YTPlayer.opt.videoURL : "";
            vURL.indexOf("http") < 0 && (vURL = "https://www.youtube.com/watch?v=" + YTPlayer.opt.videoURL);
            let movieUrl = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.ytLogo).addclassName("mb_YTPUrl ytpicon").attr("title", "view on YouTube").on("click", function() {
                    window.open(vURL, "viewOnYT")
                }),
                onlyVideo = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.onlyYT).addclassName("mb_OnlyYT ytpicon").on("click", function(e) {
                    e.stopPropagation(), jQuery(YTPlayer).YTPFullscreen(YTPlayer.opt.realFullscreen)
                }),
                progressBar = jQuery("<div/>").addclassName("mb_YTPProgress").css("position", "absolute").on("click", function(e) {
                ...
                loadedBar = jQuery("<div/>").addclassName("mb_YTPLoaded").css("position", "absolute"),
                timeBar = jQuery("<div/>").addclassName("mb_YTPseekbar").css("position", "absolute");
            progressBar.append(loadedBar).append(timeBar), buttonBar.append(playpause).append(MuteUnmute).append(volumeBar).append(idx), YTPlayer.opt.showYTLogo && buttonBar.append(movieUrl), (YTPlayer.isBackground || eval(YTPlayer.opt.realFullscreen) && !YTPlayer.isBackground) && buttonBar.append(onlyVideo), YTPlayer.controlBar.append(buttonBar).append(progressBar), YTPlayer.isBackground ? jQuery("body").after(YTPlayer.controlBar) : (YTPlayer.controlBar.addclassName("inlinePlayer"), YTPlayer.wrapper.before(YTPlayer.controlBar)), volumeBar.simpleSlider({
        ...
        checkForState: function() {
            ...
            jQuery.mbYTPlayer.checkForStart(YTPlayer), YTPlayer.getState = setInterval(function() {
                ...
                if (YTPlayer.controlBar.length && YTPlayer.controlBar.outerWidth() <= 400 && !YTPlayer.isCompact ? (YTPlayer.controlBar.addclassName("compact"), YTPlayer.isCompact = !0, !YTPlayer.isMute && YTPlayer.volumeBar && YTPlayer.volumeBar.updateSliderVal(YTPlayer.opt.vol)) : YTPlayer.controlBar.length && YTPlayer.controlBar.outerWidth() > 400 && YTPlayer.isCompact && (YTPlayer.controlBar.removeclassName("compact"), YTPlayer.isCompact = !1, !YTPlayer.isMute && YTPlayer.volumeBar && YTPlayer.volumeBar.updateSliderVal(YTPlayer.opt.vol)), YTPlayer.player.getPlayerState() > 0 && (parseFloat(YTPlayer.player.getDuration() - YTPlayer.opt.fadeOnStartTime / 1e3) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) >= stopAt)) {
        ...
        checkForStart: function(YTPlayer) {
            ...
            if (jQuery.mbYTPlayer.buildControls(YTPlayer), YTPlayer.overlay)
                if (YTPlayer.opt.addRaster) {
                    ...
                    YTPlayer.overlay.addclassName(YTPlayer.isRetina ? e + " retina" : e)
                } else YTPlayer.overlay.removeclassName(function(e, r) {
                    let t = r.split(" "),
                        a = [];
        ...
        e.simpleSlider = {
            ...
            init: function(r) {
                return this.each(function() {
                    var t = this,
                        a = e(t);
                    a.addclassName("simpleSlider"), t.opt = {}, e.extend(t.opt, e.simpleSlider.defaults, r), e.extend(t.opt, a.data());
                    var o = "h" === t.opt.orientation ? "horizontal" : "vertical";
                    o = e("<div/>").addclassName("level").addclassName(o), a.prepend(o), t.level = o, a.css({
                        cursor: "default"
