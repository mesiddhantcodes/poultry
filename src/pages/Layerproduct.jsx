...
const variants = [
    { id: 0, image: "5.jpeg", name: "Layer phase 1", description: "Used for chicks in early stages of life." },
    { id: 1, image: "", name: "Layer phase 2 ", description: "Provides balanced nutrition for growing chicks." },
    { id: 2, image: "", name: "Layer phase 3", description: "Supports growth and skeletal development." },
    { id: 3, image: "", name: "Layer Chick Crumb  / Mash ", description: "Enhances laying performance in hens." },
    { id: 4, image: "", name: "Layer Grower Crumb ", description: "Helps in uniform flock development." },
    { id: 5, image: "", name: "Layer Concentrate ", description: "Essential nutrients for high egg production." },
            ...
            <div className="row">
                ...
                <div className="col-md-8">
                    <div className="card shadow p-4">
                        ...
                        <img
                            src={`public/assets/images/${variants[activeTab].image}`}
